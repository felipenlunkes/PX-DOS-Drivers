...
;;              © 2014-2016 Felipe Miguel Nery Lunkes
;;       
;;       
;;        Andromeda - Driver para PX-DOS(R)(R) 0.9.0 ou superior
;;
;;
;;
;;*****************************************************************
...
.tipo_driver: db "ANDROMEDA  " ;; Tipo de função válida a ser exercida pelo   
                               ;; Driver  			
