...
;;                               Arquivo de Símbolos
;;
;;  Este arquivo contém símbolos em memória utilizados por outros módulos do Driver
;;                                 
;;
;;
;;**************************************************************************************

;; Simbolos, que devem ser usados para indicar ao módulo de envio serial aonde as informações
;; foram armazenadas
